...
It is then possible to query a sequence of the test set against the ones in the lookup set. The necessary scripts can be found in [/scripts](https://git.scicore.unibas.ch/schwede/EBA/-/tree/891f59f9e5b1e726e21f3c00d07b6302a1bc6824/analysis/pisces/scripts). The resulting scores will be stored in [/results](https://git.scicore.unibas.ch/schwede/EBA/-/tree/891f59f9e5b1e726e21f3c00d07b6302a1bc6824/analysis/pisces/results). For example:
